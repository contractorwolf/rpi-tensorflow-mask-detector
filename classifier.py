...
PATH_TO_CKPT = '/home/pi/tflite1/Sample_TFLite_model/edgetpu.tflite'#os.path.join(CWD_PATH,MODEL_NAME,GRAPH_NAME)

#print(PATH_TO_CKPT)


# Path to label map file
PATH_TO_LABELS = '/home/pi/tflite1/Sample_TFLite_model/labelmap.txt'#os.path.join(CWD_PATH,MODEL_NAME,LABELMAP_NAME)
...
while True:
    ...
    accuracylabel = ' %s: %d%%' % (largestlabel, largestpercent) # Example: 'person: 72%'
    screensizelabel = ' %s: %d%%' % ("Size ratio", int(largestsize/screensize*100)) # Example: 'person: 72%'
    fpslabel = ' FPS: {0:.2f}'.format(frame_rate_calc)
    templabel = ' Temp: {0:.2f}F'.format(Temp)    
