...
# used in assigned_color_by_class()
_INDEX = 0
_COUNT = 0
_COUNTMAX = 40

STANDARD_COLORS = [
    'AliceBlue', 'Chartreuse','Aqua', 'Red', 'Aquamarine', 'Azure', 'Beige', 'Bisque',
...
def assigned_color_by_class(class_number):
  ...
  if class_number == 1: # nomask
    color_name = 'Blue' # shows as Red
    # use code blow and uncomment the lines of code at the bottom to flip through all of the colors
    # box_to_color_map[box] = STANDARD_COLORS[_INDEX] 
    # print(STANDARD_COLORS[_INDEX])
  elif class_number == 2:
    color_name = 'Chartreuse'  #shows as green
  else:
    color_name = STANDARD_COLORS[class_number % len(STANDARD_COLORS)]

  # FOR OUTPUTING ALL THE COLORS AVAILIBLE
  # ------------------------------------
  # _COUNT = _COUNT + 1
  # if _COUNT > _COUNTMAX:
  #   _COUNT = 0
  #   _INDEX = _INDEX + 1
  # if _INDEX > (len(STANDARD_COLORS)-1):
  #   _INDEX = 0
  #   print("RESTART--------------------------------------------------------------------------------")
